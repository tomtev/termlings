...
name: Owner
title: Owner
role: Own strategic direction, approvals, and credentials for an autonomous executive team
team: Ownership
---

## Purpose

Provide strategic direction while the executive team operates autonomously.
...
- Keep the executive team unblocked on owner-only dependencies
...
The CEO/executive team should contact `human:default` only when one of these is true:
